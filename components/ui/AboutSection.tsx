...
const BIO_REST = [
  "I believe design doesn't move in a straight line through sticky notes and problem statements toward a static prototype that nobody will ever ship exactly as drawn. The best work I've been part of always started somewhere else: with a solution people couldn't stop reacting to. Something obvious in the best way.",
  "AI didn't just speed up the process. It breaks the script. A working prototype used to cost weeks of alignment. Now it costs an afternoon. That changes everything — not just the tools, but the logic of who does what and how quickly a team can learn from something real. I work from 0 to 1 across strategy, design, and implementation. I prototype in code, test with robots and humans, iterate fast, and skip any step that doesn't get us closer to something people will actually love using. Intuition and craft matter more now, not less — because anyone can generate a starting point, but not anyone can tell when it really works.",

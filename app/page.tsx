...
const MAIN_PROJECTS = [
  ...
  },
  {
    title: 'Open',
    description:
      'Open builds white-label insurance for brands like Huddle, Bupa, and Polestar. I redesigned the quote flows that cut drop-offs by 70% and lifted sales 20%, then built the multi-brand design system that let us deliver Bupa\'s full platform in 10 weeks, half the time a launch like that usually takes.',
...
const PERSONAL_PROJECTS = [
  ...
  },
  {
    ...
    href: 'https://www.onlyme.life/juanpablo',
  ...
  },
  {
    title: 'Onrecord',
    description:
      "It's hard to know if the people you voted for actually kept their word. I designed and built Onrecord to check automatically, pulling every vote from Parliament and matching it against the promises each candidate campaigned on.",
    href: '#',
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        {/* ── §1 Hero ──────────────────────────────────────────────────────── */}
        <Hero onToggle={handleHeroClick} onPortfolioClick={() => scrollToSection('intro')} wordmarkVariant="v2" />
        ...
        {/* ── §5 Contact + Footer ──────────────────────────────────────────── */}
        <ContactFooterV3 theme={theme} onLogoClick={() => scrollToSection('hero')} randomizeCitiesOnClick />
